...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($release_date) && !empty($release_year) && preg_match('/^\d{4}$/', $release_year)) {
        $is_tba = 1;
    ...
    // Insert game into database if no errors
    if (empty($error)) {
        $stmt = $conn->prepare("INSERT INTO games (title, release_date, tba_year, is_tba, platforms, genre, image_url, portrait_image_url, description)
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)");
        $stmt->bind_param("ssiisssss", $title, $release_date, $tba_year, $is_tba, $platforms, $genre, $image_url, $portrait_image_url, $description);
...
<head>
    ...
    <title>Add New Game - GameTracker</title>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-10 mx-auto text-center">
                <h1 class="mb-3"><i class="ph ph-plus-circle me-3"></i>Add New Game</h1>
                <p class="lead">Expand the GameTracker database by adding a new game with all its details and images.</p>
            </div>
        </div>
    </div>
</section>
            ...
            <div class="form-container">
                ...
                <form method="POST" action="" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="release_year" min="2024" max="2100" class="form-control" placeholder="2025">
                    </div>

                    <div class="mb-3">
                        <label class="form-label"><i class="ph ph-device-mobile me-2"></i>Platforms</label>
                        <input type="text" name="platforms" class="form-control" placeholder="PC, PlayStation 5, Xbox Series X/S">
                    </div>

                    <div class="mb-3">
                        <label class="form-label"><i class="ph ph-tag me-2"></i>Genres</label>
                        <input type="text" name="genre" class="form-control" placeholder="Action, Adventure, RPG">
                    </div>
                    ...
                    <div class="mb-3">
                        <label class="form-label"><i class="ph ph-upload me-2"></i>Or Upload an Image</label>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="portrait_url" name="portrait_image_url" class="form-control" placeholder="https://example.com/portrait.jpg">
                    </div>

                    <div class="mb-3">
                        <label class="form-label"><i class="ph ph-upload me-2"></i>Or Upload a Portrait Image</label>
                    ...
                    <div class="d-grid">
                        <button type="submit" class="btn btn-primary btn-lg">
                            <i class="ph ph-plus-circle me-2"></i>Add Game
                        </button>
                    </div>
                </form>
            </div>
