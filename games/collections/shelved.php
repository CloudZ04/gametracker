...
$status = 'Shelved';
$collection_label = 'Shelved';
$collection_description = "Games you've put on hold for now. They'll be here waiting when you're ready to return!";
$empty_state_message = "You haven't shelved any games yet. Take a break when you need to!";
